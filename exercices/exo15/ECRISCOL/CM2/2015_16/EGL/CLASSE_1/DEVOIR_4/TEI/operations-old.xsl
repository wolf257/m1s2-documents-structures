...
<xsl:template match="del">
		<span class="showHideSuppression"><span style="background-color:#ffff66;"><xsl:apply-templates/> </span></span>
</xsl:template>
...
<xsl:template match="mod[@type='subst']">
		...
		<span class="showHideRemplacement"><xsl:apply-templates select="del"/><xsl:text>||</xsl:text></span>
...
<xsl:template match="mod[@type='add']">
		<span class="showHideInsertion"><xsl:apply-templates/></span>
</xsl:template>


<xsl:template match="metamark">
		<span class="showHideCommentaire"><xsl:text> </xsl:text><span style="background-color:#f08494"><sup><span style="background:red;color:black"><xsl:value-of select="@time"/><xsl:value-of select="@who"/></span></sup><xsl:apply-templates/></span><xsl:text> </xsl:text></span>
</xsl:template>


<xsl:template match="sup">
		<sup><span style="background:black;color:white"><xsl:value-of select="."/></span></sup>
</xsl:template>
